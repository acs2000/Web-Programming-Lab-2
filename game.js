function start() {
    ...
    document.getElementById("speedInput").setAttribute("onchange", "bear.setSpeed()");
...
function Bear() {
    ...
    this.move = function(xDir, yDir) {
        ...
        this.fitBounds(); // keeps bear on board
        this.display();
    }
    ...
    this.fitBounds = function() {
        ...
        this.setSpeed = function() {
            ...
            this.dBear = document.getElementById("speedInput").value;
        }
